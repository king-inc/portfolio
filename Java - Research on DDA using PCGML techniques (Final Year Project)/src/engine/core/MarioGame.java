    ...
    private MarioResult gameLoop(String level, int timer, int marioState, boolean visual, int fps) {
        ...
        while (this.world.gameStatus == GameStatus.RUNNING) {
            if (!this.pause) {
                ...
                //dda
                try {
                    //TO DO actions performed is are weird please fix
                    dda.monitor(this.world.currentTick/30,this.world.mario.getMapX(), new MarioResult(this.world,gameEvents,agentEvents));
                } catch (IOException e) {
