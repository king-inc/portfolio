...
public class LevelGenerator implements MarioLevelGenerator {
    ...
    @Override
    public String getGeneratedLevel(MarioLevelModel model, MarioTimer timer, double[] difficulties) {
        model.clearMap();
        this.difficulty = round(difficulties[0]);
        odds[ODDS_STRAIGHT] = 20;
        odds[ODDS_HILL_STRAIGHT] = 10;
        odds[ODDS_TUBES] = 2 + 1 * round(difficulties[1]);
        odds[ODDS_JUMP] = 2 * round(difficulties[2]);
        odds[ODDS_CANNONS] = -10 + 5 * round(difficulties[3]);
